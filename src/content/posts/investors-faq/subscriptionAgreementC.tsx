...
import AgreementImg from  '../../../components/images/subscriptionAgreement3.webp'
  ...
  return (
    <Box p={5} bg="gray.900" color="white" borderRadius="md" shadow="lg">
      ...
      <VStack align="start" spacing={4}>
        <Text>🔹 Minimum Commitment: $5,000,000</Text>
        <Text>🔹 Maximum Commitment: $50,000,000</Text>
        <Text>🔹 Subscription Price Per Interest: $1,000 per Class C LP Unit</Text>
      </VStack>
      ...
      <List spacing={2}>
        ...
        <ListItem>Preferred Return for Class C Shares: 10% per annum.</ListItem>
        <ListItem>Lock-up Period: 24 months.</ListItem>
      </List>

      <Heading as="h3" size="lg" color="teal.200" mt={6} mb={4}>4. Fees & Expenses</Heading>
      <List spacing={2}>
        <ListItem>Management Fee: 1.50% of NAV annually</ListItem>
        <ListItem>Performance Fee: 20% above 10% hurdle</ListItem>
        <ListItem>Withdrawal Fee: 2% for early redemptions</ListItem>
      </List>
