...
const Manifesto: React.FC = () => {
  return (
    <Box p={5} bg="gray.900" color="white" borderRadius="md" shadow="lg">
      ...
      <Heading as="h3" size="lg" color="teal.200" mb={2}>1. Introduction: Why We Exist</Heading>
      <Text mb={4}>
      ...
      <Heading as="h3" size="lg" color="teal.200" mb={2}>2. Our North Star: A New Era of Wealth Creation</Heading>
      <List spacing={2}>
      ...
      <Heading as="h3" size="lg" color="teal.200" mb={2}>3. The Engine: AI, Systematic Trading, and Free Cash Flow</Heading>
      <Text mb={4}>Our strategy is powered by AI-driven execution and deep quantitative modeling.</Text>

      <Heading as="h4" size="md" color="teal.100" mb={2}>3.1 The Foundation: Free Cash Flow and AI-First Businesses</Heading>
      <List spacing={2}>
      ...
      <Heading as="h4" size="md" color="teal.100" mb={2}>3.2 Monetizing Volatility: Sell the Wall 23/7/365</Heading>
      ...
      <Heading as="h3" size="lg" color="teal.200" mb={2}>4. The Ultimate Risk-First Strategy</Heading>
      <List spacing={2}>
      ...
      <Heading as="h3" size="lg" color="teal.200" mb={2}>5. Scaling to $2.5B AUM: The Institutional Roadmap</Heading>
      <List spacing={2}>
      ...
      <Heading as="h3" size="lg" color="teal.200" mb={2}>6. The Hushh Technologies Investment Philosophy</Heading>
      <List spacing={2}>
      ...
      <Heading as="h3" size="lg" color="teal.200" mb={2}>7. Conclusion: The Future of Alpha & Aloha</Heading>
      <Text mb={4}>
        ✅ AI-driven, systematic, and risk-first. <br />
        ✅ Engineered to harvest premium while preserving capital. <br />
        ✅ Focused on the best FCF businesses, ensuring durability across all markets.
      </Text>

      <Heading as="h4" size="md" color="yellow.300" mt={4}>📢 Invest Today.</Heading>
    </Box>
  );
};
