  ...
  return (
    <Box p={5} bg="gray.900" color="white" borderRadius="md" shadow="lg">
      <Heading as="h2" size="xl" mb={4} color="teal.300">
        Hushh Fund – Frequently Asked Questions
      </Heading>
